CLASS zbsh_vn_data_manager DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZBSH_VN_DATA_MANAGER IMPLEMENTATION.
...
*        output =
   ...
   DATA : lt_bp   TYPE TABLE OF zbsh_vn_bpa1,
          lt_prod TYPE TABLE OF zbsh_vn_product.
   append value #(
  ...
  append value #(
   ...
   append value #(
                   ...
                   to lt_prod.
    insert zbsh_vn_bpa1 from table @lt_bp.
    insert zbsh_vn_product from table @lt_prod.
 ENDMETHOD.
 ...
 METHOD fill_transaction_data.
   data : o_rand type REF TO cl_abap_random_int,
          ...
          lv_ord_id type zbsh_vn_dte_id,
          lt_so type table of zbsh_vn_so_hdr,
          lt_so_i type table of zbsh_vn_so_item.
   ...
   select * from zbsh_vn_bpa1 into table @data(lt_bpa).
   select * from zbsh_vn_product into table @data(lt_prod).
   do 50 times.
       ...
       enddo.
   enddo.
   insert zbsh_vn_so_hdr from table @lt_so.
   insert zbsh_vn_so_item from table @lt_so_i.
 ENDMETHOD.


 METHOD flush.
   delete from : zbsh_vn_bpa1, zbsh_vn_product, zbsh_vn_so_hdr, zbsh_vn_so_item.
 ENDMETHOD.
ENDCLASS.
